...
$(function () {
  ...
  $('.saveBtn').on('click', function (event) {
    ...
    // event.target
    // console.log("🚀 ~ file: script.js:30 ~ event", event)
    alert($(this).parent().children().eq(0).text())
    // alert("hello")
    console.log("🚀 ~ file: script.js:33 ~ this", this)
    console.log("🚀 ~ file: script.js:35 ~ parent", $(this).parent())
  })
  ...
  var divList = $('#main-container').children();
